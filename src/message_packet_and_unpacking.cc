...
MessageUnpacking::MessageUnpacking(const char *msg_buf){
  ...
  do{
    ...
    if('\\' == flag1){
      ...
      if('1' == flag2){
        // ...log字段name开始拷贝
        std::copy(msg_beg, msg_end, m_.get_name().begin());
        // ...log字段name拷贝完成
      }else if('2' == flag2){
        // ...log字段IP开始拷贝
        std::copy(msg_beg, msg_end, m_.get_ip().begin());
        // ...log字段IP拷贝完成
      }else if('3' == flag2){
        // ...log字段Port开始拷贝
        std::copy(msg_beg, msg_end, m_.get_port().begin());
        // ...log字段Port拷贝完成
      }else if('4' == flag2){
        // ...log字段msg开始拷贝
        std::copy(msg_beg, msg_end, m_.get_msg().begin());
        // ...log字段msg拷贝完成
      }else{
        // ...log发现非法字段
